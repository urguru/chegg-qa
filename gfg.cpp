...
int main()
{
    ...
    string t_day;
    char temp;
    cin>>year>>temp>>month>>temp>>day>>t_day>>b_month>>temp>>b_day;
    Date dt1 = {b_day, b_month, 2020};
    ...
    //cout<<getDifference(dt2, dt1)<<endl;
    int day_diff=getDifference(dt2, dt1)%7;
    if(day_diff==s_index)
    {
        cout<<getDifference(dt2, dt1)+1<<endl;
    }
    else
    {
          cout <<ceil(getDifference(dt2, dt1)/7.0);
    }
    return 0;
}
