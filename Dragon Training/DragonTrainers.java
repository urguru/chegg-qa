...
public class DragonTrainers {
     ...
     * negative, displays the error message: "ERROR - number of matches must be
     * positive!" and asks again. Continues looping until the user enters a positive
     * number.
     *
     * @param input - Scanner to read values from the keyboard
    ...
    /**
     * Prompts the user with the message "Please select a dragon [Plant/Water/Fire]:
     * " and waits for user input. If the user enters a blank line, prints the error
     * message "ERROR - Dragon prompt cannot be empty" and asks the user again.
     * Repeats until the user enters a non-blank line.
     *
     * @param input - Scanner to read values from the keyboard
     ...
     * appropriate numeric value given the dragon types in the array DRAGON (i.e. 0
     * for 'P', 1 for 'W', 2 for 'F'). If it is none of these returns a -1 to
     * represent an invalid value.
     *
     * @param dragon - the UPPERCASE character to look up a value for.
    ...
    /**
     * Takes a number representing the player's choice and another representing the
     * computer's choice. Returns a 0 if they tie, a 1 if the player wins, and a -1
     * if the player loses. Note that the values map to the indexes of the array
     * DRAGONS above (0 is a Plant dragon, 1 is a Water dragon, 2 is a Fire Dragon).
     *
     * @param player - value 0-2 representing player dragon choice
     * @param cpu    - value 0-2 representing computer dragon choice
     ...
     * representing the computer's choice, and a third number that is positive if
     * the player is the winner, negative if the computer is the winner, and 0 if
     * they tied. Then displays the appropriate player defeats computer or computer
     * defeats player or tie message as given in the project description.
     *
     * @param player index into the DRAGONS array representing the player choice
     * @param cpu    index into the DRAGONS array representing the computer's choice
     * @param winner 0 for a tie, positive for a player win, negative for a computer
     *               win
     */
    ...
    /**
     * Takes the number of wins, losses and ties and displays the final message and
     * summary statistics as given in the project description.
     *
     * @param wins   number of total wins for the player
     * @param losses number of total losses for the player
    ...
    /**
     * NOTE: The main method has been completed for you. If you correctly complete
     * the methods above, the main method will "just work" and produce the correct
     * output.
     */
