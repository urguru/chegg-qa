...
void setWord(char identifier, char **grid)
{
...
void checkPlacement(char **grid, int row, int column)
{
   if (identifier == 'H')
   {
      ...
      else
      {
         if (count == 0)
         {
            ...
            printf("Word can't be placed horizontally!");
      }
   }
   ...
   else if (identifier == 'V')
   {
      ...
      else
      {
         if (count == 0)
         {
            ...
            printf("Word can't be placed vertically!");
      }
   }
...
void checkRandom(char **grid, int row, int column)
{
...
int main()
{
   ...
   char *grid[num_column];
   for(int i=0;i<num_column;++i)
   {
       grid[i]=new char[num_row];
   }
